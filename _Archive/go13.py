...
while run:  # Main loop
    ...
    while run_game:
        ...
        # render stone pits
        #size = 3*grid_size; size = 0.25*height # of the pits
        #size = 2.9*grid_size; size = size
        
        # pygame.draw.rect(window, wood1, (rx, ry + 0.45*height,  size, size)) # schnitt bei 0.125*height == 
        # pygame.draw.rect(window, wood1, (rx, ry + 0.725*height, size, size))
...
##        
##        
##        pygame.draw.circle(surface_black, wood2, rund((0.5*size, 0.5*size)), r(0.5*size)) # schnitt bei 0.125*height == 
##        pygame.draw.circle(surface_white, wood2, rund((0.5*size, 0.5*size)), r(0.5*size))
##        #pygame.draw.rect(surface_white, wood2, (0, 0, size, size))
##
##        # render stones
##        for b in stones[2]: # Black (upper pit) # b = [len, angle] # 0 << 1
##            stone_x = 0.5*size + math.cos(math.radians(b[1]*360)) * ((b[0] * 0.5*size)-st_rad)
##            stone_y = 0.5*size + math.sin(math.radians(b[1]*360)) * ((b[0] * 0.5*size)-st_rad)
##            #stone_x = size * b[0]
##            #stone_y = size * b[1]
...
##            
##        for w in stones[3]:
##            stone_x = 0.5*size + math.cos(math.radians(w[1]*360)) * ((w[0] * 0.5*size)-st_rad)
##            stone_y = 0.5*size + math.sin(math.radians(w[1]*360)) * ((w[0] * 0.5*size)-st_rad)
##            #stone_x = size * w[0]
##            #stone_y = size * w[1]
...
##        pygame.draw.circle(surface_black, wood1, rund((0.5*size, 0.5*size)), r(0.5*size), r(0.05*size)) # schnitt bei 0.125*height == 
##        pygame.draw.circle(surface_white, wood1, rund((0.5*size, 0.5*size)), r(0.5*size), r(0.05*size))

        # who's turn
#        if turn== 1: # black
#            pygame.draw.circle(surface_black, (150, 220, 250), rund((0.5*size, 0.5*size)), r(0.5*size), r(0.02*size))
#        else:
#            pygame.draw.circle(surface_white, (150, 220, 250), rund((0.5*size, 0.5*size)), r(0.5*size), r(0.02*size))
